...
In this script, we apply the Normal Topic Model (NTM) on mixture of sinusoidal gene expression data matrix with and without wavelet transformation. The idea is to replicate patterns similar to sparse factor analysis, but to focus more on clustering the samples based on the expression patterns.
...
We apply the NTM fit on a toy example (same example as in *pmd_wavelets_2.html*).
