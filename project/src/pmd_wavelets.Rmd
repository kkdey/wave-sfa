...
In this script, we use the wavelet technique for a sinusoidal time series function and then perform factor analysis on the wavelet transforms. We use sparse factor analysis due to PMD method of Witten and Tibshirani. 
