...
The wavelet transformed factor analysis seemed more efficient than applying factor analysis straightaway to the original cycle data. So variable selection after factor analysis on wavelet transformed data is more recommended than directly applying it on the cyclic data.
